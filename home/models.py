...
class Rendimentosmodel(models.Model):
    ...
    fnet_id = models.IntegerField(null=True, blank=True)
    cnpj_admin = models.IntegerField(null=True, blank=True)
    cnpj_fundo = models.IntegerField(null=True, blank=True)
